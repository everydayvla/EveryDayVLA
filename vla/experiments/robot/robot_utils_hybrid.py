...
from experiments.robot.openvla_utils_hybrid import (
    get_vla,
    get_vla_action,
    get_hybrid_vla_action,
    get_ensembled_vla_action,
    get_ensembled_temp_vla_action,
    get_cherried_action,
    get_ada_vla_action
)
...
def get_ensembled_action(
    ...
    with torch.no_grad():
        if cfg.model_family == "openvla":
            action = get_ensembled_vla_action(
                cfg=cfg,
                vla=model,
                processor=processor,
                obs=obs,
...
def get_ensembled_action_temp(
    ...
    with torch.no_grad():
        if cfg.model_family == "openvla":
            action = get_ensembled_temp_vla_action(
                cfg=cfg,
                vla=model,
                processor=processor,
                obs=obs,
