    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.num_classes > 0:
            ...
            self.label_emb = LabelEmbedder(num_classes, hidden_dim, class_dropout_prob)
            self.extras = 2
        else:
            self.extras = 1
        ...
        if num_classes > 0:
            self.final_layer = FinalLayer(hidden_dim, patch_size, self.out_channels, condition=True)
        else:
