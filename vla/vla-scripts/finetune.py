...
class FinetuneConfig:
    ...
    # vla_path: str = "/ix1/rckubendran/sac345/openvla-oft/runs/openvla-7b+libero_spatial_no_noops+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--70000_chkpt"
    ...
    # num_diffusion_steps: int = 3                    # (When `diffusion==True`) Number of diffusion steps for training
    ...
    # num_steps_before_decay: int = 600            # Number of steps before LR decays by 10x
    # num_steps_before_decay_2: int = 10_000
    # num_steps_before_decay_3: int = 20_000
    ...
    run_id_note: Optional[str] = "mamba_L1_proprio"                # Extra note to add to end of run ID for logging
        ...
        metrics.update(
            {
                ...
                "token_continuous_loss": compute_l1_loss_between_discrete_continuous_actions.item()
            }
        )
