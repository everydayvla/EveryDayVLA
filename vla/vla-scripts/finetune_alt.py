...
class FinetuneConfig:
    ...
    # vla_path: str = "/ix1/rckubendran/sac345/openvla-oft/runs_alt/openvla-7b+libero_spatial_no_noops+b32+lr-0.0005+lora-r32+dropout-0.0--image_aug+b32+lr-0.000--mixer_ssm_diff_50_steps_128_batch_size--20000_chkpt"
    # vla_path: str = "/ix1/rckubendran/sac345/openvla-oft/runs_alt/openvla-7b+six_dof_new_base_mamba_L1"
    ...
    # changed l1_regression to huber_loss
    ...
    run_id_note: Optional[str] = "mamba_L1"                # Extra note to add to end of run ID for logging
