...
class OpenVLAServer:
    def __init__(self, cfg) -> Path:
        ...
        print(f"self.vla.norm_stats: {self.vla.norm_stats}")
    ...
    def get_server_action(self, payload: Dict[str, Any]) -> str:
        try:
            ...
            observation = payload
            observation["full_image"] = np.array(observation["full_image"])
            instruction = observation["instruction"]

            print(f"obs.shape: {observation['full_image'].shape}")
...
class DeployConfig:
    ...
    pretrained_checkpoint: Union[str, Path] = ""     # Local checkpoint path or Hugging Face model id
    ...
    unnorm_key: Union[str, Path] = "consolidated_dataset"                # Action un-normalization key
