...
class FinetuneConfig:
    ...
    num_diffusion_steps: int = 5                    # (When `diffusion==True`) Number of diffusion steps for training
    ...
    run_id_note: Optional[str] = "cvae"                # Extra note to add to end of run ID for logging
