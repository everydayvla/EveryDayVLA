...
class FinetuneConfig:
    ...
    # Dataset
    data_root_dir: Path = Path("data/tensorflow_datasets")  # Directory containing RLDS datasets
    dataset_name: str = "consolidated_dataset"              # Name of fine-tuning dataset
    run_root_dir: Path = Path("runs_everydayvla")            # Directory for logs and checkpoints
    ...
    max_steps: int = 50_000                          # Max number of training steps
    ...
    run_id_note: Optional[str] = "c2f"                # Extra note to add to end of run ID for logging
